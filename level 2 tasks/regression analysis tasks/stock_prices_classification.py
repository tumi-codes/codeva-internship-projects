...
# predict close from open
plot(data, 'open', 'close')
# predict volume from open
plot(data, 'open', 'volume')
# predict volume from close
plot(data, 'close', 'volume')
# predict high from low
plot(data, 'low', 'high')
# predict high from open
plot(data, 'open', 'high')